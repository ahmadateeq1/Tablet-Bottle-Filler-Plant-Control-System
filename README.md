...
| **Discrete LEDs** | Output Device (Visual) | Provides a clear, binary visual representation of the accumulated grand total. | 8 |
| **Optical / IR Sensor** | Input Device (Physical) | Detects passing tablets and generates pulses for the accumulator stage. | 1 |
| **Dispensing Valve** | Actuator | Mechanical valve controlled by the logic circuit to dispense tablets. | 1 |
